...
for softwareObjectAtIndex in softwareObjectList:
    ...
    while(softwareObjectAtIndex.classList.find(",",comma) > -1 ):
        ...
        if (extractedBuilding == 'H'):
            ...
            if (debug == True):
                print('building: ' + extractedBuilding + ' floor: ' + extractedFloor + ' classNumber: ' + extractedClassNumber)
            ...
            for SoftwareAndClassListObjectAtIndex in SoftwareAndClassList:
                ...
                and (SoftwareAndClassListObjectAtIndex.classBuilding == tempSoftwareAndClassObject.classBuilding)
...
if (outputView == True):    
    for tempIndex in SoftwareAndClassList:
        print('Software Name: ' + tempIndex.softwareName +' Building: ' + tempIndex.classBuilding + ' Floor: ' + tempIndex.classFloor + ' ClassNumber: ' + tempIndex.classRoom)
